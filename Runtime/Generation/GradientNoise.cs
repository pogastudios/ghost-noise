...
namespace Packages.GhostNoise.Generation
{
    ...
    {
        // 256 random vectors
        private static readonly float[] _vectors = new[]
                                                        {
        ...
        /// Default 0 for non repeating noise pattern.
        /// </summary>
        ...
        Vector3 GetRandomVector(int x, int y, int z)
        {
            ...
            int vectorIndex = (
               ...
               & 0x7fffffff;
            vectorIndex = (((vectorIndex >> NoiseConstants.VALUE_SHIFT) ^ vectorIndex) & 0xff) * 3;

            return new Vector3(_vectors[vectorIndex], _vectors[vectorIndex + 1], _vectors[vectorIndex + 2]);
        }
